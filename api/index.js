...
export default async function handler(req, res) {
  ...
  try {
    ...
    const safeUsername = String(username).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;');
    const safeAvatarUrl = String(user.avatarUrl).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;');
...
<image href="${safeAvatarUrl}" x="20" y="20" height="70" width="70"/>
